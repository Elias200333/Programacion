...
public class Ejercicio8 {
	public static void main(String[] args) {
		 ...
		 * 
		 * Después solicitaremos en el bucle for el numero a escoger, y mediante una serie de "if" 
		 ...
		 * a 0, es decir, que es el primer ciclo del bucle for, haremos que directamente el numero elegido 
